...
TMSP V4.6 Release Remarks
-------------------------

1.: Improvement of product location accuracy

The TMSP V4.6 further improves the accuracy of the SAR product location in range direction.
Small range bandwidth dependent systematic offsets in the order of ± 23 cm have been eliminated
by a change in the range focusing modul software.

2.: Noise Profiles

For the imaging modes HS, SL and SC the accuracy of the annotated noise profiles has been 
further improved by a refinement of the processor noise gain determination in SPECAN mode.
As well, noise determination has been corrected for the polarization modes "Dual" and "Quad"
and is now consistently annotated as in single-pol. mode.
Note however the remarks on the radiometric calibration of 
spotlight and experimental (quad-pol.) products below. 
